...
const getCandidateDetailById = async (candidatoId) => {
    try {
      ...
      LEFT JOIN racas r ON ce.raca_id = r.id
      ...
      e.ano_eleicao, e.abrangencium_id, ce.coligacao, p.nome, p.sigla, 
  ...
  `
        ...
        const parsedCandidate = {
            ...
            coligacao: candidate?.abrangencium_id == 2 ? "Não se aplica" : candidate.coligacao?.replace(/[()]/g, ""),
