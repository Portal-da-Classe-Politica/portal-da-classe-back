...
const indicatorsPossibilities = {
    ...
    "11": {
        "id": "11",
        "nome": "Índice de Desigualdade Regional do Voto",
        "grupo": "geográfico",
        "cargos": [
            { ...cargosGlossary.vereador, required_steps: ["UF", "city", "party"] },
            { ...cargosGlossary.deputado_estadual, required_steps: ["UF", "party"] },
            { ...cargosGlossary.deputado_federal, required_steps: ["UF", "party"] },
            { ...cargosGlossary.senador, required_steps: ["UF", "party"] },
            { ...cargosGlossary.prefeito, required_steps: ["UF", "city", "party"] },
            { ...cargosGlossary.governador, required_steps: ["UF", "party"] },
